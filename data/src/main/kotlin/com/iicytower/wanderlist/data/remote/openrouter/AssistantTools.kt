...
object AssistantTools {
    val SEARCH_ATTRACTIONS = ToolDefinition(
        ...
        parameters = mapOf(
            "latitude" to mapOf("type" to "number", "description" to "Szerokość geograficzna"),
            "longitude" to mapOf("type" to "number", "description" to "Długość geograficzna"),
            "radius_km" to mapOf("type" to "integer", "description" to "Promień wyszukiwania w km"),
